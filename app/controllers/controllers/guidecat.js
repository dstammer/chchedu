...
module.exports = function (opts) {
    var catModel = opts.models.GuideCat;
    ...
    return {
        ...
        "post#guide_category/create" : function (req, res) {
            ...
            query.exec(function (err, cat) {
                if (err) {
                	...
                	return failure_callback(res, "Another category has already registered with same name.");
                }
		...
		"post#guide_category/get" : function( req, res ) {
			var _id = req.body.id;
			var query;
		...
		"post#guide_category/update" : function (req, res) {
        	// Get Request Parameters
            var id = req.body.id,
				name = req.body.name;
		...
		"post#guide_category/delete" : function( req, res) {
			var id = req.body.id;
